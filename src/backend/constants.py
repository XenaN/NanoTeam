features = {'Material': ['SiO2', 'Ag', 'TiO2', 'PLGA', 'Pt', 'ZnO', 'Au',
        'CuO', 'MgO', 'Polystyrene', 'EudragitRL', 'ZrO2', 'C60', 'C70',
        'MWCNT', 'NiO', 'Ay', 'CeO2'],
 'Type': ['I', 'O', 'C', 0.0],
 'Shape': ['Sphere', 'Irregular', 'Rod', 'Star', 'Nanotube',
        'Cubic', 'Round'],
 ...
 'Cell_Source': ['Mouse', 'Human', 'Rat', 'Monkey'],
...
features_values = {'Coat/Functional Group': ['None', 'PVP', 'Chitosan', 'Poloxamer', 'PVA', 'Citrate',
 ...
 'Material': ['SiO2', 'Ag', 'TiO2', 'PLGA', 'Pt', 'ZnO', 'Au',
        'CuO', 'MgO', 'Polystyrene', 'EudragitRL', 'ZrO2', 'C60', 'C70',
        'MWCNT', 'NiO', 'Ay', 'CeO2'], 
 'Shape': ['Sphere', 'Irregular', 'Rod', 'Star', 'Nanotube',
        'Cubic', 'Round'], 
